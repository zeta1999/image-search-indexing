...
public class ImageSearchResult implements Comparable<ImageSearchResult> {
    ...
    public ImageSearchResult(String url, String width, String height, String alt, String title,
                             String urlOriginal, String timestamp, String longdesc, String pageTitle) {
        this.url = url;
        this.width = width;
        this.height = height;
        this.alt = alt;
